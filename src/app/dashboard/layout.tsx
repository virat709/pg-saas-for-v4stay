    ...
    <div className="flex" style={{ minHeight: '100vh', backgroundColor: 'var(--bg-color)' }}>
      ...
      <aside style={{ width: '250px', backgroundColor: 'var(--surface-color)', borderRight: '1px solid var(--border-color)', padding: '1.5rem', display: 'flex', flexDirection: 'column' }}>
        <div style={{ marginBottom: '2rem' }}>
          <h2 style={{ color: 'var(--text-main)', fontSize: '1.25rem', margin: 0, lineHeight: 1.2 }}>{pgName}</h2>
          <div style={{ fontSize: '0.75rem', color: 'var(--primary)', marginTop: '0.25rem', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase' }}>
        ...
        <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem', marginTop: 'auto' }}>
          <button 
            ...
            style={{ width: '100%', padding: '0.75rem', textAlign: 'left', color: 'var(--danger)', fontWeight: 500 }}
          >
            Sign Out
          </button>
        </div>
